...
```{r}
cor_test_vector<-vector(mode="double",length=32)


cor_test_vector[1]<-cor.test(just_metrics$total_cup_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[2]<-cor.test(just_metrics$total_cup_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[3:4]<-cor.test(just_metrics$total_cup_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[5]<-cor.test(just_metrics$aroma,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[6]<-cor.test(just_metrics$aroma,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[7:8]<-cor.test(just_metrics$aroma,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[9]<-cor.test(just_metrics$flavor,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[10]<-cor.test(just_metrics$flavor,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[11:12]<-cor.test(just_metrics$flavor,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[13]<-cor.test(just_metrics$aftertaste,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[14]<-cor.test(just_metrics$aftertaste,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[15:16]<-cor.test(just_metrics$aftertaste,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[17]<-cor.test(just_metrics$acidity,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[18]<-cor.test(just_metrics$acidity,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[19:20]<-cor.test(just_metrics$acidity,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[21]<-cor.test(just_metrics$body,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[22]<-cor.test(just_metrics$body,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[23:24]<-cor.test(just_metrics$body,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[25]<-cor.test(just_metrics$balance,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[26]<-cor.test(just_metrics$balance,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[27:28]<-cor.test(just_metrics$balance,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test_vector[29]<-cor.test(just_metrics$cupper_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$p.value
cor_test_vector[30]<-cor.test(just_metrics$cupper_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$estimate
cor_test_vector[31:32]<-cor.test(just_metrics$cupper_points,just_metrics$altitude_mean_meters, conf.level = 0.99)$conf.int

cor_test<-data.frame(metric=c("total_cup_points","aroma", "flavor","aftertaste","acidity","body","balance","cupper_points"), correlation=cor_test_vector[(seq(2,30,4))], p_value=cor_test_vector[seq(1,29,4)],lower_bound_99=cor_test_vector[seq(3,31,4)], upper_bound_99=cor_test_vector[seq(4,32,4)] )
